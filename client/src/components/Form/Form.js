  ...
  if (!user?.result?.name){
    return (
      <Paper className={classes.paper} >
        ...
        Please Sign In to create your own post or like other's post.
        </Typography>
      </Paper>
    )
  }
  ...
  return (
    <Paper className={classes.paper}>
      ...
      >
        ...
        <TextField name="message" variant="outlined" label="Message" multiline minRows={4} maxRows={6} fullWidth value={postData.message} onChange={(e) => setPostData({ ...postData, message: e.target.value })}></TextField>
